    ...
    return (
        <div className="relative mt-2 w-full">
            <div className="flex justify-center">
                <div className="text-xs font-bold">Dicas para achar sua empresa:</div>
                <div className="relative group inline-block">
    
                    <button className="w-5 h-5 rounded-full bg-blue-400 text-white text-xs 
                        flex items-center justify-center ml-2">
                        ?
                    </button>

                    <div className="fixed opacity-0 mb-2 w-72 group-hover:opacity-100 transition-opacity duration-200 
                                    bg-blue-400 text-white font-bold text-xs rounded-md px-2 py-1">
                        <span>• Se estiver com problemas pra achar a empresa, tente buscar pelo site oficial</span>
                        <br />
                        <br />
                        <span>• Caso não ache sua empresa, sem problemas... selecione a opção 'Escolher nome-da-empresa manualmente'</span>
                    </div>
                </div>
